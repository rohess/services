...
#
#	auth_param basic program /apps/squid/libexec/ncsa_auth /apps/squid/etc/passwd
#
...
#	something like
#
#	auth_param digest program /apps/squid/bin/digest_auth_pw /apps/squid/etc/digpass
#
#	"children" numberofchildren
...
#	is not used.
#
#	auth_param ntlm program /apps/squid/bin/ntlm_auth
#
#	"children" numberofchildren
#	The number of authenticator processes to spawn (no default).
#	If you start too few Squid will have to wait for them to
...
#
#	auth_param negotiate program /apps/squid/bin/ntlm_auth --helper-protocol=gss-spnego
#
#	"children" numberofchildren
#	The number of authenticator processes to spawn (no default).
#	If you start too few Squid will have to wait for them to
...
#    auth_param basic program /usr/lib/squid/squid_ldap_auth -b "cn=users,dc=esodomain,dc=com" -s sub  -u cn  esotest.esodomain.com 
...
#cache_peer 172.17.66.11  parent 15600 0 no-query default
...
#
#Default:
# cache_dir ufs /apps/squid/var/cache 100 16 256
...
#
#Default:
# cache_log /apps/squid/var/logs/cache.log
...
#
#Default:
# cache_store_log /apps/squid/var/logs/store.log
...
#
#Default:
# mime_table /apps/squid/etc/mime.conf
...
#
#Default:
# pid_filename /apps/squid/var/logs/squid.pid
...
#
#Default:
# diskd_program /apps/squid/libexec/diskd

#  TAG: unlinkd_program
#	Specify the location of the executable for file deletion process.
#
#Default:
# unlinkd_program /apps/squid/libexec/unlinkd
...
#
#Default:
# pinger_program /apps/squid/libexec/pinger
...
#	/apps/squid/share/icons
#
#Default:
# icon_directory /apps/squid/share/icons
...
#
#Default:
# error_directory /apps/squid/share/errors/English
...
#
#Default:
# cache_dns_program /apps/squid/libexec/dnsserver
